...
import { SmartContractWalletSignature } from "../../associations/signature.pb";
...
export const UnverifiedSmartContractWalletSignature = {
    encode(message, writer = _m0.Writer.create()) {
        if (message.scwSignature !== undefined) {
            SmartContractWalletSignature.encode(message.scwSignature, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.scwSignature = SmartContractWalletSignature.decode(reader, reader.uint32());
                    break;
                case 5:
    ...
    fromJSON(object) {
        return {
            scwSignature: isSet(object.scwSignature)
                ? SmartContractWalletSignature.fromJSON(object.scwSignature)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.scwSignature !== undefined &&
            (obj.scwSignature = message.scwSignature
                ? SmartContractWalletSignature.toJSON(message.scwSignature)
                : undefined);
    ...
    fromPartial(object) {
        ...
        message.scwSignature =
            object.scwSignature !== undefined && object.scwSignature !== null
                ? SmartContractWalletSignature.fromPartial(object.scwSignature)
                : undefined;
