...
exports.VerifySmartContractWalletSignaturesRequest = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        for (const v of message.signatures) {
            exports.UnverifiedSmartContractWalletSignature.encode(v, writer.uint32(10).fork()).ldelim();
        }
        return writer;
    },
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.signatures.push(exports.UnverifiedSmartContractWalletSignature.decode(reader, reader.uint32()));
                    break;
                default:
    ...
    fromJSON(object) {
        return {
            signatures: Array.isArray(object === null || object === void 0 ? void 0 : object.signatures)
                ? object.signatures.map((e) => exports.UnverifiedSmartContractWalletSignature.fromJSON(e))
                : [],
        };
    },
    toJSON(message) {
        ...
        if (message.signatures) {
            obj.signatures = message.signatures.map((e) => e ? exports.UnverifiedSmartContractWalletSignature.toJSON(e) : undefined);
        }
        else {
            obj.signatures = [];
        }
    ...
    fromPartial(object) {
        ...
        const message = createBaseVerifySmartContractWalletSignaturesRequest();
        message.signatures =
            ((_a = object.signatures) === null || _a === void 0 ? void 0 : _a.map((e) => exports.UnverifiedSmartContractWalletSignature.fromPartial(e))) || [];
        return message;
    },
};
...
exports.UnverifiedSmartContractWalletSignature = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (message.scwSignature !== undefined) {
            signature_pb_1.SmartContractWalletSignature.encode(message.scwSignature, writer.uint32(10).fork()).ldelim();
        }
    ...
    decode(input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                case 1:
                    message.scwSignature = signature_pb_1.SmartContractWalletSignature.decode(reader, reader.uint32());
                    break;
                case 5:
    ...
    fromJSON(object) {
        return {
            scwSignature: isSet(object.scwSignature)
                ? signature_pb_1.SmartContractWalletSignature.fromJSON(object.scwSignature)
                : undefined,
    ...
    toJSON(message) {
        ...
        message.scwSignature !== undefined &&
            (obj.scwSignature = message.scwSignature
                ? signature_pb_1.SmartContractWalletSignature.toJSON(message.scwSignature)
                : undefined);
    ...
    fromPartial(object) {
        ...
        message.scwSignature =
            object.scwSignature !== undefined && object.scwSignature !== null
                ? signature_pb_1.SmartContractWalletSignature.fromPartial(object.scwSignature)
                : undefined;
