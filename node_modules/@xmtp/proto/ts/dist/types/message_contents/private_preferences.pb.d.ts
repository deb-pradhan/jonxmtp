    ...
    fromPartial<I extends {
        ...
        v1?: ({
            ...
            aes256GcmHkdfSha256?: ({
                ...
                gcmNonce?: Uint8Array | undefined;
                payload?: Uint8Array | undefined;
            } & { [K in Exclude<keyof I["v1"]["aes256GcmHkdfSha256"], keyof import("@xmtp/proto/ts/dist/types/message_contents/ciphertext.pb").Ciphertext_Aes256gcmHkdfsha256>]: never; }) | undefined;
