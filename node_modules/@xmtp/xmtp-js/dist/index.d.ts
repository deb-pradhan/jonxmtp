...
import { signature, publicKey, ciphertext, authn, messageApi, privateKey, invitation, privatePreferences, keystore, content, message } from '@xmtp/proto';
...
import * as _xmtp_proto_ts_dist_types_message_contents_private_preferences_pb from '@xmtp/proto/ts/dist/types/message_contents/private_preferences.pb';
...
declare class HttpApiClient implements ApiClient {
    ...
    private _publish;
    private _subscribe;
    query(params: QueryParams, { direction, limit, pageSize, }: QueryAllOptions): Promise<messageApi.Envelope[]>;
    queryIterator(params: QueryParams, options: QueryStreamOptions): AsyncGenerator<messageApi.Envelope>;
...
type ActionsMap = Map<string, privatePreferences.PrivatePreferencesAction>;
/**
 ...
 */
declare class PrivatePreferencesStore {
    #private;
    actionsMap: ActionsMap;
    constructor(persistence: Persistence, persistenceKey: string, initialData?: ActionsMap);
    get revisionKey(): string;
    static create(persistence: Persistence): Promise<PrivatePreferencesStore>;
    refresh(): Promise<void>;
    getRevision(): Promise<number>;
    setRevision(number: number): Promise<void>;
    loadFromPersistence(): Promise<ActionsMap>;
    store(): Promise<void>;
    add(actionsMap: ActionsMap): Promise<void>;
...
type PrivatePreferenceKeystoreMethods = {
    createPrivatePreference: (action: privatePreferences.PrivatePreferencesAction) => Promise<PublishParams[]>;
...
type SnapKeystoreApiDefs = typeof snapApiDefs & KeystoreApiDefs;
...
declare class InMemoryKeystore implements KeystoreInterface {
    ...
    private v1Store;
    private v2Store;
    private privatePreferencesStore;
    private authenticator;
    private accountAddress;
    private jobStatePersistence;
    constructor(keys: PrivateKeyBundleV1, v1Store: V1Store, v2Store: V2Store, privatePreferencesStore: PrivatePreferencesStore, persistence: Persistence);
...
declare class SnapKeystoreProvider implements KeystoreProvider<SnapKeystoreInterface> {
    ...
    newKeystore(opts: KeystoreProviderOptions, apiClient: ApiClient, wallet?: Signer): Promise<Flatten<{
        ...
        createPrivatePreference: (action: _xmtp_proto_ts_dist_types_message_contents_private_preferences_pb.PrivatePreferencesAction) => Promise<PublishParams[]>;
        getPrivatePreferences: () => ActionsMap;
        getPrivatePreferencesTopic: () => Promise<string>;
        savePrivatePreferences: (data: ActionsMap) => Promise<void>;
    }>>;
